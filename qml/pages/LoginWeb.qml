...
WebViewPage {
    ...
    property string redirect_uri: forumSource.value + "login"// "https://forum.sailfishos.org/login"
    property string rand

    property string auth_url: forumSource.value + "user-api-key/new?nonce=12345678&scopes=read,write&client_id=" + rand + "&application_name=SFOS-Forum-Viewer&public_key=" + encoded  //"https://forum.sailfishos.org/user-api-key/new?nonce=" + rand + rand2 + "&scopes=read,write&client_id=" + rand2 + rand + rand + rand2 + "&application_name=SFOS-Forum-Viewer" + rand + "&public_key=" + encoded
