...
Page {
    ...
    SilicaFlickable {
        ...
        Image {
            ...
            source: forumSource.value + avatar
        ...
        Image {
            id: bg
            visible: card_bg !== undefined
            anchors.fill: parent
            source: card_bg ? forumSource.value + card_bg : ""
            opacity: 0.25
        }
        ...
        function getcard(username){
            ...
            xhr.open("GET", forumSource.value + "u/" + username + "/card.json");
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    ...
                    if(d.card_background_upload_url !== undefined) card_bg = d.card_background_upload_url
