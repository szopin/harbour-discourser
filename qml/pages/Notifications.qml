...
Page {
    ...
    property string combined: forumSource.value + "site.json" // x-discourse-username
    property string combined2: forumSource.value + "notifications.json"
    ...
    function mark(notid, index) {
        ...
        xhr.open("PUT", forumSource.value + "notifications/mark-read.json");
                  ...
                  //  console.log(xhr2.responseText);
                    ...
                    for (var i=0;i<notlen;i++) {
                        ...
                        if (notific.notification_type == 16) {
                            ...
                            if (notific.data.topic_title && notific.data.topic_title !== undefined) fancy_title = notific.data.topic_title
...
getPMs();
   ...
   /* onStatusChanged: {
    ...
    ConfigurationValue {
        id: lastnot
        key: "/org/szopin/harbour-discourser/" + forconf + "lastnot"
    }
    SilicaListView {
        id:list
        anchors.fill: parent
        ...
        PullDownMenu {
            ...
            MenuItem {
                ...
                onClicked: {
                    pMs = 3
                    combined2 = forumSource.value +"latest.json?state=muted"
                    getPMs();
                }
            }
            MenuItem {
                ...
                onClicked: {
                    pMs = 1
                    combined2 = forumSource.value +"topics/private-messages/" + loggedinname + ".json"
                    getPMs();
                }
            }
            MenuItem {
                ...
                onClicked: {
                    pMs = 2
                    combined2 = forumSource.value +"topics/private-messages-sent/" + loggedinname + ".json"
                    getPMs();
                }
            }
            ...
            MenuItem {
                ...
                onClicked: {
                    pMs = 0
                    combined2 = forumSource.value + "notifications.json"
                    list.model.clear();
                    getnotifications();
                }
            }
